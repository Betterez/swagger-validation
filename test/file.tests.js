...
describe('file', function() {
  it('should validate', function() {
    var value = [65, 32];
    var ret = validateParameter(helper.makeParam('file', false), value);
  ...
  it('should not validate with required field null', function() {
    var value = null;
    var ret = validateParameter(helper.makeParam('file', true), value);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validateParameter(helper.makeParam('file', true), undefined);
    helper.validateError(ret, 1, ['testParam is required']);
  });
