...
describe('integer - int32', function() {
  it('should validate', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int32'), value);
  ...
  it('should validate with minimum', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int32', '0'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with maximum', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int32', null, '10'), value);
    helper.validateSuccess(ret, 1, [value]);
  });
  ...
  it('should validate with maximum inclusive', function() {
    var value = 32465;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int32', null, '32465'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate with minimum and maximum', function() {
    var value = 3246;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int32', '321', '32465'), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should not validate with minimum', function() {
    var value = -4563;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int32', '-2'), value);
  ...
  it('should not validate with required field null', function() {
    var value = null;
    var ret = validateParameter(helper.makeNumberParam('integer', true, 'int32'), value);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validateParameter(helper.makeNumberParam('integer', true, 'int32'), undefined);
    helper.validateError(ret, 1, ["testParam is required"]);
  });
