...
describe('array', function() {
  ...
  it('should not validate with empty object', function() {
    ...
    helper.assertValidationFailed(ret, ["testParam is not a type of array"]);
  });
  ...
  it('should not validate with one error with number with no format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of number"]);
  });
  ...
  it('should not validate with one error with number with float format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of float"]);
  });
  ...
  it('should not validate with one error with number with double format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of double"]);
  });
  ...
  it('should not validate with one error with integer with no format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of integer"]);
  });
  ...
  it('should not validate with one error with integer with int32 format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of int32"]);
  });
  ...
  it('should not validate with one error with integer with int64 format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of int64"]);
  });
  ...
  it('should not validate with two errors with number with no format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of number", "this is also a string is not a type of number"]);
  });
  ...
  it('should not validate with two errors with number with float format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of float", "this is also a string is not a type of float"]);
  });
  ...
  it('should not validate with two errors with number with double format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of double", "this is also a string is not a type of double"]);
  });
  ...
  it('should not validate with two errors with integer with no format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of integer", "this is also a string is not a type of integer"]);
  });
  ...
  it('should not validate with two errors with integer with int32 format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of int32", "this is also a string is not a type of int32"]);
  });
  ...
  it('should not validate with two errors with integer with int64 format', function() {
    ...
    helper.assertValidationFailed(ret, ["this is a string is not a type of int64", "this is also a string is not a type of int64"]);
  });
  ...
  it('should validate minItems', function () {
    ...
    helper.assertValidationFailed(ret, ["Legs should have at least 1 item(s)"]);
  });
  ...
  it('should validate maxItems', function () {
    ...
    helper.assertValidationFailed(ret, ["Legs should have at most 2 item(s)"]);
  });
  ...
  it('should not allow null items when "nullable" is false', () => {
    ...
    helper.assertValidationFailed(result, ["TestArrayItem cannot be null"]);
  })
  ...
  it('should not validate a string if it does not belong to a given enum', function() {
    ...
    param.items.enum = ['These', 'are', 'allowed', 'strings'];
    const result = validateParameter(param, value, models, validationContext);
    helper.assertValidationFailed(result, ['not_allowed is not a valid entry']);
  });
  ...
  it('should not validate a string if its length is greater than maxLength', function() {
    ...
    const result = validateParameter(param, value, models, validationContext);
    helper.assertValidationFailed(result, ['not_allowed requires a max length of 9']);
  });
  ...
  it('should not validate a string if its length is less than minLength', function() {
    ...
    param.items.minLength = 5;
    const result = validateParameter(param, value, models, validationContext);
    helper.assertValidationFailed(result, ['n-a requires a min length of 5']);
  });
  ...
  it('should not validate a number if it is less than minimum', function() {
    ...
    const result = validateParameter(param, value, models, validationContext);
    helper.assertValidationFailed(result, ['6 is below the minimum value']);
  });
  ...
  it('should not validate a number if its greater than maximum', function() {
    ...
    const result = validateParameter(param, value, models, validationContext);
    helper.assertValidationFailed(result, ['10 is above the maximum value']);
  });
  ...
  it('should include the path of the data which failed validation in the result', () => {
    ...
    helper.assertValidationFailed(result, ['someString is not a type of string']);
    ...
    helper.assertValidationFailed(result, ['2 is not a type of string']);
