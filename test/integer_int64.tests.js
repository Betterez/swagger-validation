...
describe('integer - int64', function() {
  ...
  it('should validate', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64'), value, models, validationContext);
  ...
  it('should validate with minimum', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', '0'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with maximum', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', null, '10'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });
  ...
  it('should validate with maximum inclusive', function() {
    var value = 32465;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', null, '32465'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with minimum and maximum', function() {
    var value = 3246;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', '321', '32465'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should not validate with minimum', function() {
    var value = -4563451321;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', '-2'), value, models, validationContext);
  ...
  it('should not validate with minimum with decimal', function() {
    var value = 1.2356;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', '1.23'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is not a type of int64"]);
  });

  it('should not validate with maximum with decimal', function() {
    var value = 1.42;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', null, '1.426541323432'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is not a type of int64"]);
  });

  it('should not validate with minimum inclusive with decimal', function() {
    var value = 1.2356895;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', '1.2356895'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is not a type of int64"]);
  });

  it('should not validate with maximum inclusive with decimal', function() {
    var value = 8569.26652323;
    var ret = validateParameter(helper.makeNumberParam('integer', false, 'int64', null, '8569.26652323'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is not a type of int64"]);
  });

  it('should not validate with required field null', function() {
    var value = null;
    var ret = validateParameter(helper.makeNumberParam('integer', true, 'int64'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validateParameter(helper.makeNumberParam('integer', true, 'int64'), undefined, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is required"]);
  });
