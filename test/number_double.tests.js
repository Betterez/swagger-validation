...
describe('number - double', function() {
  ...
  it('should validate', function() {
    var value = 1.5;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double'), value, models, validationContext);
  ...
  it('should validate with minimum', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', '0'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with minimum with decimal', function() {
    var value = 1.2356;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', '1.23'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with maximum', function() {
    var value = 1;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', null, '10'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with maximum with decimal', function() {
    var value = 1.42;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', null, '1.426541323432'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });
  ...
  it('should validate with minimum inclusive with decimal', function() {
    var value = 1.2356895;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', '1.2356895'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with maximum inclusive', function() {
    var value = 32465;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', null, '32465'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with maximum inclusive with decimal', function() {
    var value = 8569.26652323;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', null, '8569.26652323'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should validate with minimum and maximum', function() {
    var value = 3246;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', '321', '32465'), value, models, validationContext);
    helper.assertValidationPassed(ret, [value]);
  });

  it('should not validate with minimum', function() {
    var value = -4563.23565632;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', '-2.32333'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is below the minimum value"]);
  });

  it('should not validate with maximum', function() {
    var value = 11.26535;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double', null, '10.278974132'), value, models, validationContext);
  ...
  it('should not validate with required field null', function() {
    var value = null;
    var ret = validateParameter(helper.makeNumberParam('number', true, 'double'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validateParameter(helper.makeNumberParam('number', true, 'double'), undefined, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is required"]);
  });
  ...
  it('should not validate with true boolean', function() {
    var value = true;
    var ret = validateParameter(helper.makeNumberParam('number', false, 'double'), value, models, validationContext);
    helper.assertValidationFailed(ret, ["testParam is not a type of double"]);
  });
