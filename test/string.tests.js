...
describe('string', function() {
  it('should validate', function() {
    var value = 'Hi';
    var ret = validateParameter(helper.makeStringParam('string', false), value);
  ...
  it('should validate with enum', function() {
    var value = 'Hi';
    var ret = validateParameter(helper.makeStringParam('string', false, undefined, undefined, ['Hi', 'Hello']), value);
    helper.validateSuccess(ret, 1, [value]);
  });

  it('should validate maxLength', function() {
    var value = "ASDF";
    var ret = validateParameter(helper.makeStringParam('string', false, undefined, undefined, undefined, undefined, 3), value);
    helper.validateError(ret, 1, ["testParam requires a max length of 3"]);
  });

  it('should validate minLength', function() {
    var value = "A";
    var ret = validateParameter(helper.makeStringParam('string', false, undefined, undefined, undefined, undefined, undefined, 2), value);
    helper.validateError(ret, 1, ["testParam requires a min length of 2"]);
  });

  it('should validate when pattern does match', function() {
    var value = 'Heya';
    var ret = validateParameter(helper.makeStringParam('string', false, null, '^Heya$'), value);
    helper.validateSuccess(ret, 1, [value]);
  });
  ...
  it('should detect when complex patterns do not match', function() {
    ...
    var ret = validateParameter(helper.makeStringParam('string', false, null, complexPattern), value);
  ...
  it('should detect when more complex patterns do not match', function() {
    var value = 'http://foo@#$';
    var ret = validateParameter(helper.makeStringParam('string', false, null, basicUrlPattern), value);
  ...
  it('should not validate with string with true boolean passed in for pattern', function() {
    var ret = validateParameter(helper.makeStringParam('string', false, null, true), 'Does not matter');
  ...
  it('should not validate with string with false boolean passed in for pattern', function() {
    var ret = validateParameter(helper.makeStringParam('string', false, null, false), 'Does not matter');
  ...
  it('should not validate with string with object passed in for pattern', function() {
    var ret = validateParameter(helper.makeStringParam('string', false, null, {}), 'Does not matter');
  ...
  it('should not validate with string with random string passed in for pattern', function() {
    var ret = validateParameter(helper.makeStringParam('string', false, null, 'paosdaksnjkdashdjgad'), 'Does not matter');
  ...
  it('should not validate with required field null', function() {
    var value = null;
    var ret = validateParameter(helper.makeStringParam('string', true), value);
    helper.validateError(ret, 1, ["testParam is required"]);
  });

  it('should not validate with required field undefined', function() {
    var ret = validateParameter(helper.makeStringParam('string', true), undefined);
    helper.validateError(ret, 1, ["testParam is required"]);
  });
  ...
  it('should not validate when pattern does not match', function() {
    var value = 'Heya';
    var ret = validateParameter(helper.makeStringParam('string', false, null, '/^Goodbye$/i'), value);
  ...
  describe('string - when required is false and an empty string is provided', function () {
    ...
    it('should not validate an empty string if a minLength greater than 0 is given', function () {
      ...
      var ret = validateParameter(param, value);
