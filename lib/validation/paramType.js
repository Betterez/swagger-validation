 ...
 */
var validateParamType = function(param, req, models, validationObj, key) {
  switch ((param.paramType || param.in || '').toLowerCase()) {
    case 'q':
    case 'query':
    ...
    default:
      return paramTypes.rootObject(param, key, req, models, validationObj)
  }
};
