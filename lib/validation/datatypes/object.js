 ...
 */
function validate(schema, value, models) {
  const modelName = schema.$ref || schema.type;
  return models.hasOwnProperty(modelName) ? validateObject(schema, value, models) : helper.errorReturn(`Unknown param type ${modelName}`);
}
