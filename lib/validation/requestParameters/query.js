 ...
 */
function validateRequestQueryString({schema, req, models, validationContext, validationSettings}) {
  ...
  const validationResults = validateParameter({schema: schemaForQueryParameter, isRequired: schema.required, value, models, validationContext, validationSettings});
